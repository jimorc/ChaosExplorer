...
GLFractal4JuliaShaderProgram::GLFractal4JuliaShaderProgram()
    : GLShaderProgram()
{
...
void GLFractal4JuliaShaderProgram::BuildFragmentShader()
{
    ...
    std::string fragmentSource =
        ...
        "        z = iPower(z, vec2(3.0f, 0.0f)) - iPower(z, vec2(2.0f, 0.0f)) + z + c;"
        "        ++i;"
        "    }"
    ...
    m_fragmentShader = std::make_unique<GLShader>(GL_FRAGMENT_SHADER, fragmentSource,
        "Fractal4 fragment shader did not compile.");
}
